...
-- TODO how to load function to global
...
function fn.foldr(func, val, tbl)
    for i,v in pairs(tbl) do
        val = func(val, v)
    end
    return val
...
function fn.bind2(func, val2) -- bind second argument.
